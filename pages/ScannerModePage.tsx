                ...
                <div className="w-full max-w-md bg-white rounded-3xl shadow-xl overflow-hidden">
                    ...
                    <div className="p-6">
                        ...
                        <div className="bg-gray-50 rounded-2xl p-6 mb-8 text-center">
                            <p className="text-sm font-medium text-gray-500 uppercase tracking-wider mb-2">Sellos Acumulados</p>
                            <div className="text-5xl font-black text-gray-900">
                                {customer.stamps} <span className="text-2xl text-gray-400 font-medium">/ {stampsNeeded}</span>
                            </div>
                        </div>

                        <div className="space-y-4">
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">Monto de compra (Opcional)</label>
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="block w-full pl-7 pr-12 py-3 border-gray-300 rounded-xl focus:ring-black focus:border-black sm:text-lg border"
                                        placeholder="0.00"
                                    />
                                </div>
                            </div>
                            ...
                            <button
                                ...
                                className="w-full py-4 bg-purple-600 text-white text-lg font-bold rounded-xl shadow-md hover:bg-purple-700 active:scale-95 transition-all disabled:opacity-50"
                            >
                            ...
                            {canRedeem && (
                                <button
                                    ...
                                    disabled={isProcessing}
                                    className="w-full py-4 bg-emerald-500 text-white text-lg font-bold rounded-xl shadow-md hover:bg-emerald-600 active:scale-95 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                                >
