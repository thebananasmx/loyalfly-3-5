    ...
    <div className="max-w-3xl">
      ...
      <section className="mb-12">
        <div className="pb-4 border-b border-gray-200">
          <h2 className="text-3xl font-bold text-black">Versión 3.5.0.28</h2>
          <p className="text-base text-gray-500 mt-1">Lanzada el 9 de Abril de 2026</p>
        </div>
        ...
        <ul className="mt-8 space-y-6">
           <li className="flex items-start gap-4">
              <FeatureTag type="new" />
              <div>
                  <h3 className="font-semibold text-black">Previsualización de Apple Wallet y Google Wallet</h3>
                  <p className="text-gray-600 mt-1">
                      Se ha añadido la capacidad de previsualizar cómo se verá la tarjeta de lealtad directamente en Apple Wallet y Google Wallet desde el editor. Esto permite a los negocios ajustar el diseño y la información para garantizar una experiencia óptima en las carteras digitales de sus clientes.
                  </p>
              </div>
          </li>
        </ul>
